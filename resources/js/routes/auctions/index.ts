 ...
 */
export const bid = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/auctions/{auction}/bid'
 */
bid.url = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { auction: args }
    }
 ...
 * @route '/auctions/{auction}/bid'
 */
bid.post = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: bid.url(args, options),
    method: 'post',
})
 ...
 * @route '/auctions/{auction}/bid'
 */
    const bidForm = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/auctions/{auction}/bid'
 */
        bidForm.post = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: bid.url(args, options),
            method: 'post',
        })
 ...
 */
export const activity = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/auctions/{auction}/activity'
 */
activity.url = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { auction: args }
    }
 ...
 * @route '/auctions/{auction}/activity'
 */
activity.post = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: activity.url(args, options),
    method: 'post',
})
 ...
 * @route '/auctions/{auction}/activity'
 */
    const activityForm = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/auctions/{auction}/activity'
 */
        activityForm.post = (args: { auction: string | { uuid: string } } | [auction: string | { uuid: string } ] | string | { uuid: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: activity.url(args, options),
            method: 'post',
        })
