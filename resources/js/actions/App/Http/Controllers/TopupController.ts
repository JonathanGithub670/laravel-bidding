 ...
 */
export const simulatePayment = (args: { topup: number | { id: number } } | [topup: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/topups/{topup}/simulate'
 */
simulatePayment.url = (args: { topup: number | { id: number } } | [topup: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { topup: args }
    }
    ...
    return simulatePayment.definition.url
            .replace('{topup}', parsedArgs.topup.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/topups/{topup}/simulate'
 */
simulatePayment.post = (args: { topup: number | { id: number } } | [topup: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: simulatePayment.url(args, options),
    method: 'post',
})
 ...
 * @route '/topups/{topup}/simulate'
 */
    const simulatePaymentForm = (args: { topup: number | { id: number } } | [topup: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/topups/{topup}/simulate'
 */
        simulatePaymentForm.post = (args: { topup: number | { id: number } } | [topup: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: simulatePayment.url(args, options),
            method: 'post',
        })
