 ...
 * @route '/bank-accounts/{bankAccount}'
 */
    const updateForm = (args: { bankAccount: number | { id: number } } | [bankAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/bank-accounts/{bankAccount}'
 */
        updateForm.put = (args: { bankAccount: number | { id: number } } | [bankAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: update.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 * @route '/bank-accounts/{bankAccount}'
 */
    const destroyForm = (args: { bankAccount: number | { id: number } } | [bankAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/bank-accounts/{bankAccount}'
 */
        destroyForm.delete = (args: { bankAccount: number | { id: number } } | [bankAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroy.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
 ...
 */
export const setPrimary = (args: { bankAccount: number | { id: number } } | [bankAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/bank-accounts/{bankAccount}/set-primary'
 */
setPrimary.url = (args: { bankAccount: number | { id: number } } | [bankAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { bankAccount: args }
    }
 ...
 * @route '/bank-accounts/{bankAccount}/set-primary'
 */
setPrimary.post = (args: { bankAccount: number | { id: number } } | [bankAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: setPrimary.url(args, options),
    method: 'post',
})
 ...
 * @route '/bank-accounts/{bankAccount}/set-primary'
 */
    const setPrimaryForm = (args: { bankAccount: number | { id: number } } | [bankAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/bank-accounts/{bankAccount}/set-primary'
 */
        setPrimaryForm.post = (args: { bankAccount: number | { id: number } } | [bankAccount: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: setPrimary.url(args, options),
            method: 'post',
        })
